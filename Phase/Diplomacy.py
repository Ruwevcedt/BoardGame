...
class Diplomacy:
    ...
    def _negotiation(self, game: World, from_suit: str, to_suit: str) -> (str, str, bool):
    ...
    def _suggestion(self, game: World, from_suit: str, to_suit: str, marks: list[str], letters: list[str]) \
    ...
    def _response(self, game: World, from_suit: str, to_suit: str, marks: list[str], letters: list[str]) \
            -> (str, str, list[Card]) or None:
        _ideal_cards = game.ideal_cards
        _response = []
        for card in _ideal_cards:
